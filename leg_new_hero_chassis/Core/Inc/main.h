...
#define JOINT4_Pin GPIO_PIN_0
#define JOINT4_GPIO_Port GPIOA
#define JOINT3_Pin GPIO_PIN_2
#define JOINT3_GPIO_Port GPIOA
#define JOINT2_Pin GPIO_PIN_9
#define JOINT2_GPIO_Port GPIOE
#define ACC_INT_Pin GPIO_PIN_10
#define ACC_INT_GPIO_Port GPIOE
#define GYRO_INT_Pin GPIO_PIN_12
#define GYRO_INT_GPIO_Port GPIOE
#define JOINT1_Pin GPIO_PIN_13
