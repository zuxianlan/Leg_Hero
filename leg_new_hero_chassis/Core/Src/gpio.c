...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, JOINT4_Pin|JOINT3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, JOINT2_Pin|JOINT1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : JOINT3_Pin */
  GPIO_InitStruct.Pin = JOINT3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(JOINT3_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : JOINT2_Pin JOINT1_Pin */
  GPIO_InitStruct.Pin = JOINT2_Pin|JOINT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
