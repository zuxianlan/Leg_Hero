...
// 需手动修改
// #define GxOFFSET 0.00194764603f
// #define GyOFFSET 0.00493789883
// #define GzOFFSET (-0.000866768416f)
// #define AxOFFSET (-0.276801348f)
// #define AyOFFSET (-0.056586355f)
// #define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
// #define gNORM 9.84484291f


#define GxOFFSET  (0.00212288089f)
#define GyOFFSET (-0.00771172531f)
#define GzOFFSET  (-0.00295343343f)
#define AxOFFSET (0.0208425689f)
#define AyOFFSET (-0.120238766f)
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM  9.8702297
