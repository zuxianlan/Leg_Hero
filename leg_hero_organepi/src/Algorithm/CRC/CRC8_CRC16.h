...
/**
  ...
  * @retval         计算完的CRC16
  */
extern uint16_t get_CRC16_check_sum(const uint8_t *pchMessage,uint32_t dwLength,uint16_t wCRC);
...
/**
  ...
  * @retval         真或者假
  */
extern uint32_t verify_CRC16_check_sum(const uint8_t *pchMessage, uint32_t dwLength);
...
extern const uint16_t crc_16_table[256];
