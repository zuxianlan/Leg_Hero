...
typedef enum
{
    ...
    Motor_DM_Control_Method_1_TO_4_ONLY_OMEGA,
    Motor_DM_Control_Method_1_TO_4_GYRO_ANGLE_YAW,
    Motor_DM_Control_Method_1_TO_4_GYRO_ANGLE_PITCH,
    Motor_DM_Control_Method_1_TO_4_RELATIVE_ANGLE_YAW,
    second_order_linear_controller_yaw,
    second_order_linear_controller_pitch,
...
{
    angle_pid_control=0,
    only_omega_pid_control,
} Motor_Pid_Control_Mode_e;
...
typedef struct {
    ...
    Motor_Pid_Control_Mode_e motor_pid_control_mode;

    PID_control Angle_PID;
    PID_control Omega_PID;
    PID_control Only_Omega_PID;
    ...
    float Feedforward_Accel;    // 前馈的角加速度, rad/s2
...
typedef struct {
    ...
    PID_control Relative_Omega_PID;
